...
def main(args,data_dict):
    ...
    def do_plot(dmm, training_data_sequences,training_data_sequences_u, test_data_sequences,test_data_sequences_u, n_re,n_epoch,z_dim = args.z_dim):
        ...
        latent_x_phy = torch.reshape(Z_loc_pri_0[:,:,0],(N_re*N_len,))
        latent_v_phy = torch.reshape(Z_loc_pri_0[:,:,1],(N_re*N_len,))
        reg_1_phy = LinearRegression(fit_intercept=True)
        reg_2_phy = LinearRegression(fit_intercept=True)
        res_1_phy = reg_1_phy.fit(data_in.reshape(-1,1), latent_x_phy.data)
        res_2_phy = reg_2_phy.fit(V.reshape(-1,1), latent_v_phy.data)
        R_square_1_phy = reg_1_phy.score(data_in.reshape(-1,1), latent_x_phy.data)
        R_square_2_phy = reg_2_phy.score(V.reshape(-1,1), latent_v_phy.data)
        RMSE_1_phy = np.sqrt(mean_squared_error(data_in.reshape(-1,1), latent_x_phy.data))
        RMSE_2_phy = np.sqrt(mean_squared_error(V.reshape(-1,1), latent_v_phy.data))

        latent_x_phy_test = torch.reshape(Z_loc_pri_0_test[:,:,0],(N_re_test*N_len_test,))
        latent_v_phy_test = torch.reshape(Z_loc_pri_0_test[:,:,1],(N_re_test*N_len_test,))
        reg_1_phy_test = LinearRegression(fit_intercept=True)
        reg_2_phy_test = LinearRegression(fit_intercept=True)
        res_1_phy_test = reg_1_phy_test.fit(data_in_test.reshape(-1,1), latent_x_phy_test.data)
        res_2_phy_test = reg_2_phy_test.fit(V_test.reshape(-1,1), latent_v_phy_test.data)
        R_square_1_phy_test = reg_1_phy_test.score(data_in_test.reshape(-1,1), latent_x_phy_test.data)
        R_square_2_phy_test = reg_2_phy_test.score(V_test.reshape(-1,1), latent_v_phy_test.data)
        ...
        return fig1,fig2,fig3,fig4,fig5,fig6,fig7,fig8,fig9,fig10,fig11,R_square_1,R_square_2,R_square_1_test,R_square_2_test,RMSE_1,RMSE_2,RMSE_1_test,RMSE_2_test,R_square_1_phy,R_square_2_phy,R_square_1_phy_test,R_square_2_phy_test,RMSE_1_phy,RMSE_2_phy,RMSE_1_phy_test,RMSE_2_phy_test
    ...
    for epoch in range(args.start_epoch, args.start_epoch + args.num_epochs):
        ...
        if val_test_frequency > 0 and epoch >= 0 and epoch % val_test_frequency == 0:
            ...
            fig1,fig2,fig3,fig4,fig5,fig6,fig7,fig8,fig9,fig10,fig11,R_square_1,R_square_2,R_square_1_test,R_square_2_test,RMSE_1,RMSE_2,RMSE_1_test,RMSE_2_test,R_square_1_phy,R_square_2_phy,R_square_1_phy_test,R_square_2_phy_test,RMSE_1_phy,RMSE_2_phy,RMSE_1_phy_test,RMSE_2_phy_test = do_plot(dmm, training_data_sequences,training_data_sequences_u, test_data_sequences,test_data_sequences_u,372,epoch)
            ...
            writer.add_scalar('R_square_1_phy', R_square_1_phy, epoch)
            writer.add_scalar('R_square_2_phy', R_square_2_phy, epoch)
            writer.add_scalar('R_square_1_phy_test', R_square_1_phy_test, epoch)
            writer.add_scalar('R_square_2_phy_test', R_square_2_phy_test, epoch)
            writer.add_scalar('RMSE_1_phy', RMSE_1_phy, epoch)
            writer.add_scalar('RMSE_2_phy', RMSE_2_phy, epoch)
            writer.add_scalar('RMSE_1_phy_test', RMSE_1_phy_test, epoch)
            writer.add_scalar('RMSE_2_phy_test', RMSE_2_phy_test, epoch)
